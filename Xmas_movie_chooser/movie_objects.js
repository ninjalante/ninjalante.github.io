...
let XmasMovies = [
    ...
    },
    {
        ...
        myScore: 73,
        summary: "A bakery HR rep and a visiting corporate heir teach each other life lessons.",
        comments: "It's very average for Hallmark. But knowing how long it takes to make a wreath, I could not believe how many she made overnight.",
        romance: true,
        musical: false,
        mistakenIdentity: true, 
        charmingInn: false,
    ...
    },
    {
        ...
        myScore: 69,
        summary: "An aging pop star who needs to stay relevant collaborates with a handsome high school music teacher to write a Christmas hit.",
        comments: "There's always some hugely contrived reason why a small-town guy/girl and an enormously huge star meet and end up spending the week before Christmas together, but this one really takes the cake. It took a little bit too long for them to meet, in my book, and the slow-motion song-writing montage made me roll my eyes, because Netflix looooooves a montage. However. I LOOOOOOOOVE that Freddie Prinze, Jr., got to play a Latinx man, with a Latinx family, and there were almost no white characters at all! The one white character undertood what a quinceañera was without any 'splaining, and the jumps between Spanish and English felt natural. Also, directed by a Latinx woman? And at least two Latinx writers credited? Yes, please! ",
        romance: true,
        musical: false,
        mistakenIdentity: false, 
        charmingInn: false,
    ...
    },
    {
        ...
        comments: "New York at Christmas is magical chaos, and somehow, this dumb little show made me feel that holiday spirit hard. Great action sequences as well, and I won't spoil the other things that I enjoyed in case you haven't seen it. PLUS: a deaf Latinx actress with a prosthetic leg playing a deaf superhero with a prosthetic leg. ",
        romance: false,
        musical: false,
        mistakenIdentity: true, 
        charmingInn: false,
    ...
    },
    {
        ...
        myScore: 85,
        summary: "A small-time crook gets involved with big-time murder after he tries to rob a toy store on Christmas Eve.",
        comments: "In the same vein of DIE HARD, while a Christmas movie, it's not Christmassy -- which is the only reason it's scored less than 90. This was so badly mismarketed when it came out, I was lucky to see it at all. Plus, brought RDJ back right before he blew up as Tony Stark. And Val Kilmer is a potty-mouthed delight.",
        romance: true,
        musical: false,
        mistakenIdentity: true, 
        charmingInn: false,
    ...
    },
    {
        ...
        myScore: 80,
        summary: "Teams of bakers complete cupcake, confection, and cake challenges with holiday themes against a ticking clock.",
        comments: "I'm seriously addicted to this show, and I've watched every episode multiple times. I don't usually like cooking competition shows, but I like that the judges are nice, especially when something has gone horribly wrong. It always makes me want to bake, AND, the editing is immaculate.",
        romance: false,
        musical: false,
        mistakenIdentity: false,
        charmingInn: false,
    ...
    },
    {
        ...
        myScore: 64,
        summary: "Hoping to cheer up their good friend, two alien misfits travel to Earth to get him a Christmas present: actor Kevin Bacon.",
        comments: "It was only 41 minutes, but it felt both like nothing happened, and that it was too long. The musical performances are fun, and I genuinely enjoyed the opening song where some aliens try to figure out what Christmas is all about. But it felt like...a big inside joke for James Gunn alone. Mantis is really mean to Drax and calls him stupid, which I really didn't like since he's kind of a poster child for neurodivergence. AND it inserted itself into being necessary viewing for the rest of the MCU because of two key pieces of information that are introduced. How expensive was this?! And how many power converters did they have to buy to light up all of Knowhere using American Christmas lights?!",
        romance: false,
        musical: true,
        mistakenIdentity: false, 
        charmingInn: false,
    ...
    },
    {
        ...
        myScore: 89,
        summary: "Two bored, obscenely wealthy brothers make a wager that they can take a bum and turn him into a financier, and take a prep school boy and turn him into a bum - but the bums fight back.",
        comments: "This one comes with a few caveats: first off, not family-friendly at all. Lotsa boobies, at least one use of the N-word, and all the swears. Secondly, John Landis, the director, was a bad person whose negligence on-set lead to the death of three actors, two of whom were children. Thirdly, it's the 80s, so, just know it was a different time. All that being said, this movie is fantastic. It's SO funny, and the sword which it wields to skewer the rich and how little they value anything other than money - including those making them money - is sharp as hell. It gets extra Christmassy points for the Eat the Rich Vibe which Dickens himself would approve. Bonus: watch out for a very young, very skinny, not-nearly-as-scary-as-usual Giancarlo Esposito in the holding cell scene.",
        romance: true,
        musical: false,
        mistakenIdentity: true, 
        charmingInn: false,
    ...
    },
    {
        title: "Violent Night",
        myScore: 79,
        summary: "A jaded Santa Claus with a dark past rediscovers his purpose when the house he's visiting is infiltrated by merciless thieves.",
        comments: "Just the poster for this was enough to send my expectations sky high. I'm all for reimaginings of Santa Claus, I just don't always enjoy them. But David Harbour killing people with a sledgehammer? Absolutely. Sadly...it did not meet my expectations. It felt like the script development was rushed, or maybe overtinkered, so that our time is split between Santa and the Lightstone family, most of whom are really terrible people, but we're still supposed to worry about them. IMHO, it took too long for Santa to go full Rambo, and the clumsy conversations between him and Trudy were too bland to build up the emotional bond we needed between them. Once Santa picks up his weapon of choice, it's fantastic fun for a good 30-40 minutes. Some of the violence is REALLY painful, REALLY horrifying, but REALLY funny. Santa's final kill left me in utter shock. Sadly, the last ten minutes were a half-assed attempt at redemption for this terrible family, and leave you kind of bored and wanting more bloodthirsty Santa. I'd still watch a sequel though. ",
        romance: false,
        musical: false,
        mistakenIdentity: true,
        charmingInn: false,
